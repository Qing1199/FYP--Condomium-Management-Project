   ...
   <input type="checkbox" id="menu-toggle">
    <div class="sidebar">
        <div class="side-header">
            <h3><img src="images/houseIcon.png" style="width: 30px; height: 30px;"></span> </h3>
        </div>
        ...
        <header>
            <div class="header-content">
                ...
                <div id="subMenu" class="user-profile-menu">
                                    ...
                                    Welcome, <b><?php echo $row['adminFName'] . ' ' . $row['adminLName']; ?></b>
                                    <hr>
                    ...
                    <div>
                        <table width="100%">
                            ...
                            <tbody>
                                ...
                                if ($stmt = $conn->prepare("SELECT * FROM announcement INNER JOIN condominium ON announcement.condoID = condominium.condoID ORDER BY announcementID DESC LIMIT ?,?")) {
